...
describe ('Testing Suite for Routes', ()=> {
  ...
  describe ('POST /signup', () => {
    ...
    it('Sucsessfully creates a user in the database and responds with a json object', () => request(server)
    .post('/api/signup')
    .send({username: testUser, password: testPass, arn: testArn, region: testRegion})
    .then(response => {
  ...
  describe ('POST /login', () => {
    ...
    it('Responds with a 200 status code and a json object', () => request(server)
    .post('/api/login')
    ...
    it('If user doesn\'t exist, responds with a 200 status code and "No user exists"', () => request(server)
    .post('/api/login')
